...
* **28/03/18** - Now printing the decryptyed plaintext to the shell. I am going to try and implement an ML model that can take a string and insert spaces into the semantically correct positions. 
